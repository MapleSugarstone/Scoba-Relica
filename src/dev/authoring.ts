...
export const REFERENCE: RefGroup[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { form: "icon <name>", says: "The sigil it shows, from assets/Sigils.", example: "icon firework" },
      { form: "planted <art>", says: "Drawn on the mark it is planted under, from assets/Powers. A status with one is a patch of ground.", example: "planted grove" },
      { form: "lit <color>", says: "The colour the holder's line art is drawn in while it carries this.", example: "lit #d9553f" },
      ...
      { form: "spends a stack", says: "One stack answers a trigger, and it is gone once it has.", example: "spends a stack" },
      ...
      { form: "power <share> + <n> at max level", says: "The same, with a flat amount scaled by the source's level. The share can be left out.", example: "power 60% of source magic + 50 at max level" },
    ],
  },
  {
    label: "Passive lines",
  ...
  },
  {
    ...
    in: ["fields"],
    lines: [
      { form: "icon <name>", says: "The sigil it shows.", example: "icon firework" },
  ...
  },
  {
    ...
    lines: [
      ...
      { form: "hit by magic | physical | <element>", says: "The same, for one kind of damage.", example: "when hit by firework:" },
  ...
  },
  {
    ...
    lines: [
      ...
      { form: "ally pawns | enemy pawns", says: "Every Pawn standing on that side of the field.", example: "ally pawns" },
    ],
  },
  {
    ...
    lines: [
      ...
      { form: "hit <who> ... + <n>% of their max hp", says: "Adds a share of the target's own HP bar, cut by armor like the rest.", example: "hit target 100% strength + 100% of their max hp" },
      { form: "hit <who> ..., bouncing at <n>% throwing <art>", says: "Carries on to every other enemy, each taking that share of the one before.", example: "hit target 100% strength, bouncing at 70% throwing rockthrow" },
      { form: "basic attack <who>", says: "One free basic attack, the same swing a chosen attack makes.", example: "basic attack other" },
      { form: "hit ..., as <element> <physical|magic>, sound <name>", says: "Options on a hit.", example: "hit target 100% magic, as firework magic" },
      { form: "hit ..., as mixed", says: "Both at once: the shares of magic are magical and the rest is physical.", example: "hit target 100% strength + 100% magic, as mixed" },
      { form: "damage <who> <share>, as <element> <physical|magic|true>", says: "A set amount, no chart, no same-type bonus, no armor.", example: "damage holder 15% of source magic, as firework magic, fixed when applied" },
      ...
      { form: "heal <who> power", says: "Heals by what the status or the patch snapshotted as it landed.", example: "heal holder power" },
  ...
  },
  {
    ...
    lines: [
      ...
      { form: "plant <status> under <who>", says: "Grows a patch on each mark. It stands there on its own and reaches whoever is standing on it.", example: "plant grove-patch under ally scobas" },
      { form: "sap <n> mana from <who>", says: "Takes mana off each Scoba, down to an empty bar.", example: "sap 5 mana from other" },
  ...
  },
  {
    ...
    lines: [
      ...
      { form: "summon <species> at <n>% level, copying <who>, except <status>", says: "At a share of the caller's level, with the moves, statuses and bred lean of who it copies. The steps after it reach it as \"raised\".", example: "summon cottlecorn at 60% level, copying caster" },
      ...
      { form: "if <who> stands:", says: "Runs the steps under it only if one of them is standing.", example: "if target stands:" },
  ...
  },
  {
    ...
    in: STEPPED,
    lines: [
      { form: "<who> shake | lunge | blink | rear | focus | dance", says: "Plays an animation.", example: "caster lunge" },
      ...
      { form: "show <art> as rise on <who>", says: "Art that starts somewhere about the Scoba and drifts up as it fades.", example: "show musicnote as rise on caster" },
      { form: "show itself as ghost on <who>", says: "The Scoba's own drawing, swelling out of it.", example: "show itself as ghost on caster" },
  ...
  },
  {
    ...
    lines: [
      ...
      { form: "<element> moves x<n>", says: "The holder's attacks of that element.", example: "firework moves x1.25" },
      ...
      { form: "blocks <element> hits", says: "Stops the next hit of that element and spends a charge.", example: "blocks firework hits" },
      { form: "cannot switch out", says: "The holder cannot be called back.", example: "cannot switch out" },
      { form: "cannot cast spells", says: "The holder cannot cast any of its moves.", example: "cannot cast spells" },
  ...
  },
  {
    ...
    in: ["fields"],
    lines: [
      { form: "<element> moves x<n>", says: "That element's attacks from the side under it.", example: "firework moves x1.25" },
